...
func (s *UsuarioService) CambiarEstado(ctx context.Context, id int, estadoID int, actualizadoPor int) error {
	return s.Repo.ChangeEstado(ctx, id, estadoID, actualizadoPor)
}
